...
def index():
    ...
    posts = current_user.followed_posts().paginate(1, current_app.config['POSTS_PER_PAGE'], False)
    return render_template('index.html', title='Home', form=form, posts=posts.items)

@bp.route('/explore')
def explore():
    posts = Post.query.order_by(Post.timestamp.desc()).paginate(1, current_app.config['POSTS_PER_PAGE'], False)
